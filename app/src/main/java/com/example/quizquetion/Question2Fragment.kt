...
import com.example.quizquetion.databinding.FragmentQuestion2Binding

class Question2Fragment : Fragment(R.layout.fragment_question1) {
   ...
   val dataModel : DataModel by activityViewModels()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnNext2.setOnClickListener {
            findNavController()
                .navigate(Question2FragmentDirections
                    .actionQuestion2FragmentToQuestion3Fragment())
        }
