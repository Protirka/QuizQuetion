...
import com.example.quizquetion.databinding.FragmentQuestion3Binding

class Question3Fragment : Fragment(R.layout.fragment_question1) {
   ...
   val dataModel : DataModel by activityViewModels()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnNext.setOnClickListener {
            findNavController()
                .navigate(Question3FragmentDirections
                    .actionQuestion3FragmentToQuestion4Fragment())
        }
